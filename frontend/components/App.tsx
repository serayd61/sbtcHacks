    ...
    <ToastProvider>
      <main className="min-h-screen bg-black">
        ...
        <section className="border-b border-gray-800 bg-gradient-to-b from-gray-950 via-gray-950 to-black relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-4 py-10 sm:py-14 text-center relative">
            ...
            <div className="flex justify-center gap-6 sm:gap-8 mt-8 sm:mt-10">
              <div className="text-center group">
                <div className="w-11 h-11 sm:w-12 sm:h-12 mx-auto mb-2 rounded-xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center group-hover:bg-orange-500/20 transition-colors">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                  </svg>
                </div>
                <p className="text-xs sm:text-sm font-semibold text-orange-400">Covered Calls</p>
                <p className="text-xs text-gray-500 mt-0.5">Strategy</p>
              </div>
              <div className="text-center group">
                <div className="w-11 h-11 sm:w-12 sm:h-12 mx-auto mb-2 rounded-xl bg-green-500/10 border border-green-500/20 flex items-center justify-center group-hover:bg-green-500/20 transition-colors">
                ...
                <p className="text-xs sm:text-sm font-semibold text-green-400">Auto-Compound</p>
                <p className="text-xs text-gray-500 mt-0.5">Yield</p>
              </div>
              <div className="text-center group">
                <div className="w-11 h-11 sm:w-12 sm:h-12 mx-auto mb-2 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center group-hover:bg-blue-500/20 transition-colors">
                ...
                <p className="text-xs sm:text-sm font-semibold text-blue-400">On-Chain</p>
